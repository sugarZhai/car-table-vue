export default {
  ...
  'workplace.popularContent': '汽车用品销售统计',
  'workplace.popularContent.text': '品牌',
  'workplace.popularContent.image': '项目组',
  'workplace.popularContent.video': '城市',
  'workplace.categoriesPercent': '品牌类型占比',
  'workplace.pecs': '个',
};
