export default {
  ...
  'workplace.popularContent': 'Car Accessories Sales',
  'workplace.popularContent.text': 'Brand',
  'workplace.popularContent.image': 'Project Team',
  'workplace.popularContent.video': 'City',
  'workplace.categoriesPercent': 'Brand Categories Percent',
  'workplace.pecs': 'pecs',
};
